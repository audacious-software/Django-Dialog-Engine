...
def incremental_backup(parameters):
    ...
    dumpdata_apps = (
        'django_dialog_engine.DialogScript',
        'django_dialog_engine.DialogStateTransition',
        'django_dialog_engine.Dialog',
    )
    ...
    for app in dumpdata_apps:
        logger.info('[django_dialog_engine] Backing up %s...', app)
        sys.stdout.flush()
