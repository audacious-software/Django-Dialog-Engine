...
class HttpTestCase(TestCase):
    def setUp(self):
        with open('django_dialog_engine/tests/scripts/http_script.json',) as definition_file:
        ...
        with open('django_dialog_engine/tests/scripts/http_script_fail.json',) as fail_file:
